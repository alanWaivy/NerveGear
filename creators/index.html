...
<body>
  ...
  <nav>
    ...
    <li ><a href="../product/index.html">All Products</a></li>
		<li><a href="../about/index.html">About Us</a></li>
		<li  id="mainPage" ><a href="../creators/index.html">Creators</a></li>
	</ul>
...
<footer>
    ...
    <!--glow effect 05 start -->
    <div id="glowEf05"><img src="../pics/glow effect 05.png" alt="glowEf05"></div>
 
    <!--glow effect 05 end -->
 <div id="fcontainer">
 
     <img src="../pics/Payment icons.png" alt="">
     <p>Copyright 2024 © NerveGear</p>
     <p>Site Built By <a href="">Us</a></p>
 
 </div>
 
 <!--glow effect 06 start -->
  <div id="glowEf06"><img src="../pics/glow effect 06.png" alt="glowEf06"></div>
